...
export class UtilityPayComponent {
  ...
  pageSize = 20;
   ...
   constructor(private service: TransactionsService){
    ...
    this.expenses$ = this.service.getUtilityPaymentsInDates(formatDate(this.startValue), formatDate(this.endValue)).pipe(startWith([]));
   }
